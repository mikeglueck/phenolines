...
d3.phenotypeIcons = function() {
  ...
  var iconDef = {
    'HP:0001438': {'empty': '\u0041', 'fill': '\u0042'}, // Abdomen -- DEPRICATED
    'HP:0001871': {'empty': '\u0043', 'fill': '\u0044'}, // Blood
    'HP:0000769': {'empty': '\u0045', 'fill': '\u0046'}, // Breast
    'HP:0001626': {'empty': '\u0047', 'fill': '\u0048'}, // Cardiovascular
    'HP:0003549': {'empty': '\u0049', 'fill': '\u004a'}, // Connective tissue
    'HP:0000598': {'empty': '\u004b', 'fill': '\u004c'}, // Ear
    'HP:0000818': {'empty': '\u004d', 'fill': '\u004e'}, // Endocrine
    'HP:0000478': {'empty': '\u004f', 'fill': '\u0050'}, // Eye
    'HP:0000119': {'empty': '\u0051', 'fill': '\u0052'}, // Genetourinary
    'HP:0001507': {'empty': '\u0053', 'fill': '\u0054'}, // Growth
    'HP:0000152': {'empty': '\u0055', 'fill': '\u0056'}, // Head / neck
    'HP:0002715': {'empty': '\u0057', 'fill': '\u0058'}, // Immune
    'HP:0001574': {'empty': '\u0059', 'fill': '\u005a'}, // Integument
    'HP:0040064': {'empty': '\u0061', 'fill': '\u0062'}, // Limbs
    'HP:0001939': {'empty': '\u0063', 'fill': '\u0064'}, // Metabolism / homeostasis
    'HP:0003011': {'empty': '\u0065', 'fill': '\u0066'}, // Musculature
    'HP:0000707': {'empty': '\u0067', 'fill': '\u0068'}, // Nervous system
    'HP:0001197': {'empty': '\u0069', 'fill': '\u006a'}, // Prenatal / birth
    'HP:0002086': {'empty': '\u006b', 'fill': '\u006c'}, // Respiratory
    'HP:0000924': {'empty': '\u006d', 'fill': '\u006e'}, // Skeletal
    'HP:0045027': {'empty': '\u006f', 'fill': '\u0070'}, // Thoracic cavity
    'HP:0001608': {'empty': '\u0071', 'fill': '\u0072'}, // Voice
    'HP:0002664': {'empty': '\u0073', 'fill': '\u0074'}, // Neoplasm
    // New, "Constitutional Symptom" need icon
    'HP:0025142': {'empty': '\u0057', 'fill': '\u0058'}, // Constitutional symptom
    'HP:0025031': {'empty': '\u0041', 'fill': '\u0042'}, // Digestive system (using old icon for Abdomen)
  };
